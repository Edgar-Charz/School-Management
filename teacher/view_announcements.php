...
// Retrieve announcements for this teacher
$announcements_stmt = $conn->prepare("SELECT * FROM announcements WHERE teacher_id = ? ORDER BY created_at DESC");
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-content">
            ...
            <ul class="menu-list">
                ...
                <li><a href="view_announcements.php" class="active"><i class="bi bi-card-list"></i> <span class="menu-text">View Announcements</span></a></li>
