...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $announcement_stmt = $conn->prepare("INSERT INTO announcements (teacher_id, title, message) VALUES (?, ?, ?)");
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-content">
            ...
            <ul class="menu-list">
                ...
                <li><a href="add_announcement.php" class="active"><i class="bi bi-megaphone"></i> <span class="menu-text">Add Announcement</span></a></li>
                <li><a href="view_announcements.php"><i class="bi bi-card-list"></i> <span class="menu-text">View Announcements</span></a></li>
                <li><a href="view_students.php"><i class="bi bi-people"></i> <span class="menu-text">View Students</span></a></li>
    ...
    <div class="main-area" id="main-area">
        ...
        <div class="main-content" style="display: flex; justify-content: center; align-items: center; min-height: 80vh;">
            <div class="card p-4" style="max-width: 500px; width: 100%; box-shadow: 0 4px 24px rgba(52,152,219,0.15); border-radius: 16px;">
                <h3 class="mb-3 text-center" style="color:#3498db; font-weight:600;">
                    <i class="bi bi-megaphone"></i> Send Announcement
                </h3>
                <form method="POST" id="announcementForm" autocomplete="off">
                    <div class="mb-3">
                        <label for="title" class="form-label" style="font-weight:500;">Announcement Title</label>
                        <input type="text" class="form-control" name="title" id="title" maxlength="100" required
                            style="border-radius:8px; width: 95%; border:1px solid #3498db; padding:10px;">
                    </div>
                    <div class="mb-3">
                        <label for="message" class="form-label" style="font-weight:500;">Message</label>
                        <textarea class="form-control" name="message" id="message" rows="5" maxlength="1000" required
                            style="border-radius:8px; width: 95%; border:1px solid #3498db; padding:10px; resize:vertical;"></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary w-100" style="background:#3498db; border-radius:8px; font-weight:600; font-size:16px;">
